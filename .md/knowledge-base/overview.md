...
| Feature         | Description                                                                                                                                                                                                                                                                                                        |
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Auth**        | Email + password signup/login/logout, session via signed HTTP-only cookie (30-day expiry). "Forgot password" emails a reset link (Resend) that lands on a dedicated reset form via a `?resetToken=` URL param. No email verification, no rate limiting on attempts. |
